...
** Flashing/debugging
*** OpenOCD
+ TODO: document forks here
+ TODO: move openocd stuff here from other places
+ OpenOCD works with AT32, using STLINK V2 (clone), and this command:
...
** CURRENT Document boards that I currently have
